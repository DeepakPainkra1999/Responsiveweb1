        ...
        <div className='container'>
            ...
            <div className="row">
                <div className="col-md-12">
                    <ul className ="counters_stats m-0 p-0 d-flex flex-wrap align-items-center">
                        {funFacts.funFactsItem.map((data,i)=>(
                            ...
                            key={i}
                                ...
                                >
                                    <div className="counters_stats-box h-100 translateEffect1">
                                        <div className="counters_stats-icon">
                                            <img
                                            className="img-fluid"
                                            src={data.icon}
                                            alt="icon"
                                        ...
                                        <div className="counters_stats-box_number">
